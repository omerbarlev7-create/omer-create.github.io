# Pinned Carousel — caption

Instagram shows the first ~125 characters before "more", so the hook has to
land inside line one. Everything below the fold is for people who already
stopped.
...
```
#OMER_AI #יצירת_תוכן_AI #בינה_מלאכותית #תוכן_AI #קריאייטיב_AI #מותג_אישי
#יוצרי_תוכן #בעלי_עסקים #שיווק_דיגיטלי #מוניקה_AI
#AIcontent #AIvideo #contentcreation #personalbranding #storytelling
```
...
## Why the caption is long

A pinned post is not a feed post. Its job is not reach — it is to explain the
whole thing to someone who just landed on the profile and is deciding whether to
follow or leave. That reader has already chosen to engage, so length costs
